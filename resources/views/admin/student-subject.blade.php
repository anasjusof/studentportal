        ...
        <div class="portlet box portlet-style">
            <div class="portlet-title">
                <div class="caption">
                    ...
                    <span class="caption-subject font-white sbold uppercase">Student Info</span>
                </div>
            </div>
            ...
            <div class="portlet-body">
                <div class="table-scrollable table-scrollable-borderless">
                    <div class="form-group col-md-12">
                        ...
                        <div class="col-md-8">
                                <input type="text" name="student_name" class="form-control input-line" id="m_name" disabled="" value="{{ $student->student_name }}">
                        </div>
                    </div>
                    <div class="form-group col-md-12">
                        <label for="inputPassword1" class="col-md-4 control-label">Semester</label>
                        <div class="col-md-8">
                                <input type="text" name="student_sem" class="form-control input-line" id="m_email" disabled="" value="{{ $student->student_sem }}">
                        </div>
                    </div>
                    <div class="form-group col-md-12">
                        <label for="inputPassword1" class="col-md-4 control-label">Department</label>
                        <div class="col-md-8">
                                <input type="text" name="student_department" class="form-control input-line" id="m_department" disabled="" value="{{ $student->student_department }}">
                        </div>
                    </div>
                </div>
      ...
      <!-- BEGIN BORDERED TABLE PORTLET-->
        <div class="portlet box portlet-style">
            ...
            <div class="portlet-body">
                ...
                <div class="row">
                <div class="col-md-6">
                  {!! Form::open(['method'=>'DELETE', 'action'=>['AdminController@deleteStudentSubject'], 'id'=>'form_delete']) !!}
...
<div id="addModal" class="modal fade" role="dialog">
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
      	<div class="row">
      	{!! Form::open(['method'=>'POST', 'action'=>'AdminController@createStudentSubject']) !!}
	        <div class="form-group col-md-12">
